...
// See Dear ImGui GLFW & Vulkan example code
...
Overlay::Overlay(const OverlaySpecification& overlaySpecification)
    : m_Specification(overlaySpecification)
{
    s_Instance = this;
...
void Overlay::Init()
{
    ...
    glfwSetWindowAttrib(m_WindowHandle, GLFW_MOUSE_PASSTHROUGH, GLFW_TRUE);
	...
	glfwSetWindowSize(m_WindowHandle, videoMode->width, videoMode->height);
